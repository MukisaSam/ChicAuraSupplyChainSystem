<div x-data="{ open: false }" class="relative">
    ...
    <div x-show="open" @click.away="open = false"
         class="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg z-50 border border-gray-200 dark:border-gray-700"
         style="display: none;" x-transition>

        <div class="p-4 border-b border-gray-100 dark:border-gray-700 font-semibold text-gray-700 dark:text-gray-200">
            Admin Notifications
        </div>
        ...
        <ul class="max-h-80 overflow-y-auto">
            @if(Auth::user()->role === 'admin')
                ...
                <a href="{{ route('admin.notifications.index') }}"
                   class="ml-2 text-xs text-blue-600 hover:underline font-semibold flex items-center">
                    View All
                </a>
            @else
                <li class="px-4 py-6 text-center text-gray-400">Unauthorized Access</li>
            @endif
        </ul>
    </div>
</div>
