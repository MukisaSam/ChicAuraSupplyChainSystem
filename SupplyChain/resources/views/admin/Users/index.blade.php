        ...
        <aside id="sidebar" class="sidebar absolute md:relative z-20 flex-shrink-0 w-64 md:block">
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-2 space-y-1">
                    ...
                    <a href="{{route('admin.users')}}" class="nav-link flex items-center px-3 py-2 text-white bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl shadow-lg"><i class="fa-solid fa-user"></i><span class="ml-2 text-sm">Users</span></a>
                </nav>
