            ...
            <main class="flex-1 p-4 overflow-auto">
                <div class="container mx-auto px-2 sm:px-4 md:px-8 py-6">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                        <div>
                            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Sales Report</h1>
                            <p class="text-gray-700 dark:text-gray-300">Detailed sales analysis from {{ $startDate }} to {{ $endDate }}</p>
                        </div>
