            ...
            <header class="header-gradient relative z-10 flex items-center justify-between h-16 border-b">
                <div class="flex items-center">
                    ...
                    <div class="relative ml-3 hidden md:block">
                        ...
                        <input type="text" class="w-80 py-2 pl-10 pr-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent text-sm" placeholder="Search products...">
                    </div>
                </div>
                                                ...
                                                <div class="flex items-center space-x-4">
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <div class="flex items-center space-x-4 mt-2">
                                                            ...
                                                            <span class="text-sm text-gray-500">Material: {{ $item->material }}</span>
                                                            <span class="text-sm text-gray-500">Stock: {{ $item->stock_quantity }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="text-right">
                                                        <p class="text-xl font-bold text-gray-900">${{ number_format($item->base_price, 2) }}</p>
                                                        <div class="flex items-center space-x-2 mt-2">
                                                            ...
                                                            <input type="number" 
                                                                   ...
                                                                   class="w-20 border border-gray-300 rounded-lg px-2 py-1 text-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                            ...
                            <div class="card-gradient rounded-xl p-6 sticky top-4">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <select name="payment_method" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                                    ...
                                    <div>
                                        ...
                                        <textarea name="shipping_address" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="Enter your shipping address">{{ old('shipping_address') }}</textarea>
                                    </div>
                                    
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Notes (Optional)</label>
                                        <textarea name="notes" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="Any special instructions...">{{ old('notes') }}</textarea>
                                    </div>
    ...
    <script>
        ...
        function updateTotal() {
            ...
            quantityInputs.forEach(input => {
                ...
                const itemCard = input.closest('.bg-white');
