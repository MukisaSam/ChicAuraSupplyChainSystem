    ...
    <div class="flex h-screen">
        ...
        <aside id="sidebar" class="sidebar absolute md:relative z-20 flex-shrink-0 w-64 md:block">
            <div class="flex flex-col h-full">
                ...
                <div class="px-4 py-4">
                    <h3 class="text-white text-sm font-semibold mb-3 px-3">WHOLESALE PORTAL</h3>
                </div>
                <nav class="flex-1 px-4 py-2 space-y-1">
                    ...
                    <a href="#" class="nav-link flex items-center px-3 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-xl"><i class="fas fa-shopping-cart w-5"></i><span class="ml-2 text-sm">Orders</span></a>
                ...
                <div class="flex items-center pr-4 space-x-3">
                    ...
                    <div class="relative">
                        <button class="flex items-center focus:outline-none bg-white rounded-full p-2 shadow-md hover:shadow-lg transition-shadow">
                            ...
                            <img class="w-7 h-7 rounded-full border-2 border-purple-200" src="https://via.placeholder.com/28" alt="User Avatar">
                        </button>
                    </div>
                </div>
            </header>
