    ...
    <div class="bg-white rounded-lg shadow-lg overflow-x-auto">
        <table class="min-w-full table-auto">
            ...
            <tbody>
                ...
                <tr class="even:bg-gray-50 hover:bg-indigo-50 transition">
                    ...
                    <td class="border-t px-4 py-2">
                        <div class="flex flex-wrap gap-2">
                            <a href="{{ route('manufacturer.production-schedules.show', $schedule->id) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-1 px-3 rounded-lg shadow transition">View</a>
                            <a href="{{ route('manufacturer.production-schedules.edit', $schedule->id) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-1 px-3 rounded-lg shadow transition">Edit</a>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center text-gray-400 py-8">No production schedules found.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
