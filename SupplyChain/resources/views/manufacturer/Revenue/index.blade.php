    ...
    <div class="flex h-screen">
            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-2 space-y-1">
                    ...
                    <a href="{{route('manufacturer.reports')}}" class="nav-link flex items-center px-3 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-xl">
                     ...
                     <a href="{{route('manufacturer.revenue')}}" class="nav-link flex items-center px-3 py-2 text-white bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-xl shadow-lg">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="flex-1 p-4 overflow-hidden">
                <div class="mb-4">
                    <h2 class="text-2xl font-bold text-white mb-1">Revenue</h2>
