...
<div class="container mx-auto py-6">
    <h1 class="text-2xl font-bold text-white mb-4">Production Work Orders</h1>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    ...
                    <a href="{{ route('manufacturer.production.edit', ['production' => $order->id]) }}" class="ml-2 text-yellow-600 hover:underline">Edit</a>
                </td>
            </tr>
            @empty
            <tr>
