...
<div class="container mx-auto py-8 flex justify-center">
    <div class="w-full max-w-lg bg-white rounded-lg shadow-lg p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Create New Work Order</h1>
        <form method="POST" action="{{ route('manufacturer.production.store') }}">
            ...
            <div class="mb-5">
                <label class="block font-semibold text-gray-700 mb-2">Scheduled Start</label>
            ...
            <div class="mb-5">
                <label class="block font-semibold text-gray-700 mb-2">Scheduled End</label>
