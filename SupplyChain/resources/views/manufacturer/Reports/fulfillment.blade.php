...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-bold text-black mb-6 flex items-center gap-3">Order Fulfillment Report</h2>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white dark:bg-gray-900 rounded shadow">
            <thead>
                <tr>
                    <th class="px-4 py-2 text-left text-xs font-medium text-black uppercase tracking-wider">Number</th>
                    ...
                    <th class="px-4 py-2 text-left text-xs font-medium text-black uppercase tracking-wider">Items Count</th>
                </tr>
            </thead>
            <tbody>
