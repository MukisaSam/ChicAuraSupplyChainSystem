...
<div class="container mx-auto py-6">
    <h1 class="text-2xl font-bold text-white mb-4">Create Quality Check</h1>
    <form method="POST" action="{{ route('manufacturer.quality.store') }}">
        @csrf
        <div class="mb-4">
            <label class="block font-semibold text-white mb-1">Work Order</label>
        ...
        <div class="mb-4">
            <label class="block font-semibold text-white mb-1">Stage</label>
            <input type="text" name="stage" class="w-full border rounded p-2" required>
        </div>
        <div class="mb-4">
            <label class="block font-semibold text-white mb-1">Result</label>
        ...
        <div class="mb-4">
            <label class="block font-semibold text-white mb-1">Checked By</label>
        ...
        <div class="mb-4">
            <label class="block font-semibold text-white mb-1">Checked At</label>
