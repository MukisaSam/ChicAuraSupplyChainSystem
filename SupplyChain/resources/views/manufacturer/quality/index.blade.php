...
<div class="container mx-auto py-6">
    <h1 class="text-2xl font-bold text-white mb-4">Quality Checks</h1>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    ...
                    <a href="{{ route('manufacturer.quality.edit', ['quality' => $qc->id]) }}" class="text-yellow-600 hover:underline ml-2">Edit</a>
                </td>
            </tr>
            @empty
            <tr>
