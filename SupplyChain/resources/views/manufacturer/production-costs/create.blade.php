    ...
    <div class="w-full max-w-lg bg-white rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('manufacturer.production-costs.store') }}">
            ...
            <div class="mb-5">
                ...
                <input type="number" name="amount" class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" min="0" step="0.01" required>
            </div>
            <div class="mb-5">
