         ...
         <div class="sidebar fixed left-0 w-64 h-[calc(100vh-60px)] p-4 shadow-lg flex flex-col justify-between">
            <div>
                <nav>
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('admin.dashboard') }}" class=" @yield('admin_dashboard','flex items-center p-2 text-gray-600 hover:bg-gray-100 rounded-lg')">
                        ...
                        <li>
                            <a href="{{ route('admin.analytics')}}"
                                class="@yield('admin_analytics','flex items-center p-2 text-gray-600 hover:bg-gray-100 rounded-lg')">
                        ...
                        <li>
                            <a href="{{ route('admin.inventory')}}"
                                class="@yield('admin_inventory','flex items-center p-2 text-gray-600 hover:bg-gray-100 rounded-lg')">
                        ...
                        <li>
                            <a href="#" class="flex items-center p-2 text-gray-600 hover:bg-gray-100 rounded-lg">
                                ...
                                <span class="sidebar-text">Wholesalers</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.suppliers') }}" 
                               class="@yield('admin_suppliers','flex items-center p-2 text-gray-600 hover:bg-gray-100 rounded-lg')">
                        ...
                        <li>
                            ...
                            class="@yield('admin_users','flex items-center p-2 text-gray-600 hover:bg-gray-100 rounded-lg')">
